...
class TestSlidingWindowMedian(unittest.TestCase):
    ...
    test_example_1.__doc__ = "timeout: 1"
    ...
    test_example_2.__doc__ = "timeout: 1"
    ...
    test_empty_array.__doc__ = "timeout: 1"
    ...
    test_single_element_window.__doc__ = "timeout: 1"
    ...
    test_large_array.__doc__ = "timeout: 60"
    ...
    test_negative_numbers.__doc__ = "timeout: 1"
    ...
    test_mixed_numbers.__doc__ = "timeout: 1"
